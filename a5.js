...
// poszTexture = textureLoader.load( "images/ABCD.jpg" ); 

// negxTexture = textureLoader.load( "images/ABCD.jpg" ); 
// negyTexture = textureLoader.load( "images/ABCD.jpg" ); 
// negzTexture = textureLoader.load( "images/ABCD.jpg" ); 
...
// TODO:  change to use a better minFilter: changed from NearestFilter to LinearMipmapNearestFilter
// minFilter: when the texture is minified (more texture pixels than screen pixels).
// effective for textures that are often seen at a distance or at steep angles, common in 3D environments
...
negzWall.rotation.y = 0;
negzWall.rotation.z = -2*Math.PI;
scene.add(negzWall);
...
// // Ripple
// ///////////////////////////////////////////////////////////////////////////////////////
// rippleMaterial.uniforms.frequency = { value: 2.0 };
// rippleMaterial.uniforms.speed = { value: 1.0 };
// rippleMaterial.uniforms.amplitude = { value: 0.1 };
...
//   // Assuming your material has a time uniform
//   yourMaterial.uniforms.time.value = elapsedTime;
